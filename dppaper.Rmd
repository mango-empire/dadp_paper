...
It has served as the theoretical foundation for many recent advances in privacy technology. Several high profile
...
a fast, flexible, and user-friendly way to analyze privatized data.
...
```{r post-or-density, fig.cap="(Example 1) posterior density estimate for the odds ratio using 9000 MCMC draws.",  fig.height=3, fig.width=5, fig.align='center'}
tv <- dp_out$chain
