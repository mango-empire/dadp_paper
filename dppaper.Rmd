...
the more noise that needs to be added to achieve a given privacy guarantee [@Ju2022]. Example 2, will cover an
...
The `dapper_sample` function returns a `draw_matrix` object as described
...
Looking at left hand plot in \@ref(fig:post-or-compare) shows the MAP estimate from `dapper`
