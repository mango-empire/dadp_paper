...
df2 <- tibble(confidential = odds_ratio_conf, dapper = or) 
...
\[
\begin{aligned}
\hat{\beta} &= (-0.04, -6.81, -3.00)\\
\hat{\hat{\Sigma}} &= insert
\end{aligned}
\]

Figure [X] shows the posterior density estimates for the $\beta$ coefficients.
