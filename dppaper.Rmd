...
It implements the Bayesian framework proposed by @Ju2022. This framework describes how to modify
an existing Bayesian model to account for privacy noise and `dapper`
...
added privacy noise. Compared to other Bayesian approaches, the `dapper` framework 
is model agnostic and requires no tuning parameters. The algorithmic run time 
complexity of dapper is similar to the non-private analysis (section 2). The goal of  `dapper` is to provide
