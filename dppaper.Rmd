...
serves as user-friendly interface for implementing the framework in R. It is a flexible interface that allows the user to input
a sampler from an existing Bayesian workflow, unadjusted for privacy noise, and 
