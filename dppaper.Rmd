...
the syntax `post_f(dmat, theta)`. Here `dmat` is a numeric matrix representing the confidential data
and `theta` is a numeric vector which serves as the initialization point for one-step draw. 
