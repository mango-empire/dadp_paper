...
```{r regression-compare, fig.cap="Comparison between dapper and a naive approach that ignores the privacy mechanism", echo = FALSE, fig.height=1.5, fig.width=5, fig.align='center'}
