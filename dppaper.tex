...
\item
  ...
  Typically
  This function has the form \texttt{priv\_f\ =\ f(arg1,\ arg2,\ ..)} where \texttt{arg1} is the
  the value of \(s_{dp}\) and \texttt{arg2} is the.
\item
...
Thus \texttt{dapper} helps fill an urgent need by providing researchers a way to evaluate
...
While \texttt{dapper} can be a nice addition to a privacy researcher's tool kit, there
