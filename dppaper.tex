...
It implements a Bayesian framework proposed in (Ju et al. 2022). This framework describes how to modify
an existing Bayesian model to account for privacy noise. DAPPER
serves as user-friendly interface for implementing the framework in R. It gives the user
a great deal of flexibility by allowing the user to input
