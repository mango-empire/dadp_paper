...
been common practice in statistical disclosure control (Dalenius and Reiss 1982), differential privacy
...
a weaker criteria. The \texttt{dapper} package implements probability mass and sampling functions
...
and both are, in fact, used in several current US Census data products (Labs 2022).
