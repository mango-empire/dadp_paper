...
under a different framework called concentrated differential privacy (Bun and Steinke 2016) which is
a weaker definition. The \texttt{dapper} package implements probability mass and sampling functions
...
\texttt{dapper} accommodates both the randomized response and
...
distribution to \(6.25\) which will guarantee it is \(2\log(3)\)-differentially private\footnote{\(\dfrac{1}{2} \epsilon^2\)-concentrated differential privacy implies \(\left(\dfrac{1}{2}\epsilon^2 + \epsilon \sqrt{2\log(1/\delta)}, \delta\right)\)-differential privacy (Bun and Steinke 2016)}.
